...
@click.option('--test-size', default=0.2, type=float, help='Test set size (0-1)')
...
@click.option('--min-samples-split', default=2, type=int, help='Minimum samples to split')
...
def train(data_path, test_size, n_estimators, max_depth, min_samples_split, random_state):
    ...
    with mlflow.start_run(run_name="Wine_Classifier_Training"):
        ...
        if not os.path.exists(data_path):
            ...
            print("Creating dataset from sklearn...")
